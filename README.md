...
$$^\land(a\backslash 1(?=a^*\backslash 2)a | (b^+))^*\$ $$
...
То есть такому языку $L_1 = L \cap R$ будут принадлежать все строки вида $b^n a b^m a b^k,\quad n, m, k \ge 1 \space \& \space n \ge m \space \& \space k \ge m$
